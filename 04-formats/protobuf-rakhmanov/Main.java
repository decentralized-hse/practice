...
public final class Main {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return Main.internal_static_Project_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Main.Project.class, Main.Project.Builder.class);
    }
    ...
    public static Main.Project parseFrom(
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(Main.Project other) {
        if (other == Main.Project.getDefaultInstance()) return this;
    ...
    static {
      DEFAULT_INSTANCE = new Main.Project();
    }

    public static Main.Project getDefaultInstance() {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return Main.internal_static_Student_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Main.Student.class, Main.Student.Builder.class);
    }
    ...
    public static Main.Student parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(Main.Student other) {
        if (other == Main.Student.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          Main.Project, Main.Project.Builder, Main.ProjectOrBuilder> projectBuilder_;
      /**
       * <code>.Project project = 5;</code>
       * @return Whether the project field is set.
       */
      ...
      public Builder setProject(
          Main.Project.Builder builderForValue) {
        if (projectBuilder_ == null) {
      ...
      public Main.ProjectOrBuilder getProjectOrBuilder() {
        if (projectBuilder_ != null) {
          ...
          return project_ == null ?
              Main.Project.getDefaultInstance() : project_;
        }
      }
      /**
       * <code>.Project project = 5;</code>
    ...
    static {
      DEFAULT_INSTANCE = new Main.Student();
    }

    public static Main.Student getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
      ...
      students.forEach(student -> {
        try {
          Student s = Student.newBuilder()
                  ...
                  .setPractice(com.google.protobuf.ByteString.copyFrom(student.practice))
                  .setProject(Project.newBuilder().setRepo(student.project.repo).setMark(student.project.mark).build())
