...
func TestLWWTie(t *testing.T) {
	a := ISFRtlvt(ZipInt64(1), Time{4, 8})
	b := ISFRtlvt(ZipInt64(2), Time{4, 7})
	c := ISFRtlvt(ZipInt64(2), Time{4, 5})
